...
class Weibo:
    cookie = {"Cookie": "_T_WM=1665d3135b04cb4bc30d0cc18b62172d; ALF=1542099520; SCF=AsgfwnllZ8SOEFWSN0So_T_ceqSmVPGr1K2H3ESjxI5quNTobHJaz8-QyU0or_mhjDt9y3M3nAuNJP7O85f3-Do.; SUBP=0033WrSXqPxfM725Ws9jqgMF55529P9D9WWEMyqm58e03EBjAN66.INY5JpX5K-hUgL.FoeXS0nRS0qRe0e2dJLoIpjLxK-L1K5LBoBLxKBLB.BLBoeLxKnLB.BLBoqt; SUB=_2A252x3U6DeRhGeVK7FoZ9yjEyD-IHXVSSBtyrDV6PUJbkdANLWPMkW1NTFUFHIj75OQPtMylEphAv2DUiBJz5yaP; SUHB=0A05z9U7N4Wbtb;SSOLoginState=1539507562; WEIBOCN_FROM=1110006030; MLOGIN=1; M_WEIBOCN_PARAMS=uicode%3D20000174"}  # 将your cookie替换成自己的cookie

    # Weibo类初始化
    def __init__(self, user_id, filter=1):
        # self.user_id = 5632680978  # 用户id，即需要我们输入的数字，如昵称为“Dear-迪丽热巴”的id为1669879400
        self.user_id = 1826792401  # 用户id，即需要我们输入的数字，如昵称为“Dear-迪丽热巴”的id为1669879400
